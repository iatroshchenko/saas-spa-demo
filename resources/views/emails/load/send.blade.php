...
<head>
    ...
    <title>{{ config('app.name') }} Load Email</title>
                ...
                <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="padding: 30px 30px 0; color: #8094ae; font-family: 'DM Sans', Arial, 'Helvetica Neue', sans-serif;">
                            <p style="margin-bottom: 10px; color: #8094ae; font-family: 'DM Sans', Arial, 'Helvetica Neue', sans-serif;">Dear {{ $load->loadShipper->first_name }},</p>
                    ...
                    <tr>
                        <td style="padding: 30px 30px 20px; color: #8094ae; font-family: 'DM Sans', Arial, 'Helvetica Neue', sans-serif;">
                            ...
                            <p style="margin-bottom: 10px; color: #8094ae; font-family: 'DM Sans', Arial, 'Helvetica Neue', sans-serif;">
                                ...
                                <b style="padding-left: 10px; padding-right: 5px;">Load ID: </b> {{ $load->id }}
                            </p>
                            ...
                            <div style="margin-left: 30px; margin-bottom: 10px; color: #8094ae; font-family: 'DM Sans', Arial, 'Helvetica Neue', sans-serif;">
                                ...
                                <ul>
                                    @foreach($load->loadVehicles as $vehicle)
                            ...
                            <p style="margin-bottom: 10px; color: #8094ae; font-family: 'DM Sans', Arial, 'Helvetica Neue', sans-serif;">
                                ...
                                <b style="padding-left: 10px; padding-right: 5px;">Origin: </b> {{ $load->loadOrigin->address_string }}
                            </p>

                            <p style="margin-bottom: 10px; color: #8094ae; font-family: 'DM Sans', Arial, 'Helvetica Neue', sans-serif;">
                                {{--                                <img src="{{ asset('images/email/destination.png') }}" alt="">--}}
                                <b style="padding-left: 10px; padding-right: 5px;">Destination: </b> {{ $load->loadDestination->address_string }}
                            </p>

                            <p style="margin-bottom: 10px; color: #8094ae; font-family: 'DM Sans', Arial, 'Helvetica Neue', sans-serif;">
                                {{--                                <img src="{{ asset('images/email/calendar-icon.png') }}" alt="">--}}
                                <b style="padding-left: 10px; padding-right: 5px;">First Available Date: </b> {{ $load->loadTransport->available_date->format('Y/m/d') }}
                            </p>

                            <p style="margin-bottom: 10px; color: #8094ae; font-family: 'DM Sans', Arial, 'Helvetica Neue', sans-serif;">
                                {{--                                <img src="{{ asset('images/email/truck-icon.png') }}" alt="">--}}
                                <b style="padding-left: 10px; padding-right: 5px;">Carrier type: </b> {{ $load->loadTransport->carrier_type_name }}
                            </p>

                            <p style="margin-bottom: 10px; color: #8094ae; font-family: 'DM Sans', Arial, 'Helvetica Neue', sans-serif;">
                                {{--                                <img src="{{ asset('images/email/price.png') }}" alt="">--}}
                                <b style="padding-left: 10px; padding-right: 5px;">Total price: </b> $ {{ $load->loadTransport->price }}
                            </p>
                            ...
                            <p style="text-align: center; padding: 20px; margin-bottom: 10px; color: #8094ae; font-family: 'DM Sans', Arial, 'Helvetica Neue', sans-serif;">
                                <a href="" style="background-color:#2660f7;border-radius:4px;color:#ffffff;display:inline-block;font-size:14px;font-weight:700;line-height:44px;text-align:center;text-decoration:none;text-transform: uppercase; padding: 0 25px">
                                    Confirm This Order
                                </a>
                            </p>
