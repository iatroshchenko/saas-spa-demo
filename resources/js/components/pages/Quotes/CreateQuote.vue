<template>
  <div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h6 class="card-title">Create {{ entityTypeCapitalize }}</h6>
          ...
          <div class="row">
                        ...
                        <form class="forms-sample">
                          ...
                          <div class="row">
                            <div class="col-lg-6 col-12">
                              ...
                              <ValidationProvider name="Address 1" rules="min:10|max:50" v-slot="{ errors }">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6 col-12">
                              ...
                              <ValidationProvider name="Address 2" rules="min:10|max:50" v-slot="{ errors }">
                                <div class="form-group">
                              ...
                              <ValidationProvider name="City" rules="min:3|max:50" v-slot="{ errors }">
                                <div class="form-group has-predictions">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <ValidationObserver ref="vehicleInfo">
                        ...
                        <ValidationProvider name="Vehicle Year" :rules="{required: true, numeric: true, min_value: 1936, max_value: (new Date()).getFullYear() }" v-slot="{ errors }">
                          <div class="form-group">
                          ...
                          <div class="input-group date datepicker" id="available_date">
                            ...
                            <span @click="showAvailableDateDatepicker" class="input-group-addon"><svg
                              ...
                              class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2"
                                                                     ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line>
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group date datepicker" id="delivery_date">
                            ...
                            <span @click="showDeliveryDateDatepicker" class="input-group-addon"><svg
                              xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                              stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                              class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
            ...
            <div v-show="currentStep.name === 'Transport'" class="col-12">
              <div>
                <a @click="createQuote" class="btn btn-primary">Create {{ entityTypeCapitalize }}</a>
              </div>
            </div>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        /* Quote or Order */
        entityType: this.$route.name === 'shipper.orders.create' ? 'order' : 'quote',
        entityTypeCapitalize: this.$route.name === 'shipper.orders.create' ? 'Order' : 'Quote',
        entityTypeUpperCase: this.$route.name === 'shipper.orders.create' ? 'ORDER' : 'QUOTE',
        ...
        formData: {
          ...
          quote_vehicle_is_running: false,
    ...
    methods: {
      ...
      loadClients() {
        client.get('/api/shipper/' + this.$route.params.shipper_id + '/clients/all')
          .then(res => {
      ...
      createQuoteRequest() {
        client.post('/api/shipper/' + this.$route.params.shipper_id + `/${this.entityType}s/`, {
          ...this.formData,
        })
          .then(res => {

            this.$swal('Success', `${this.entityTypeCapitalize} has been created`, 'success')
              .then(() => {
                router.push(
                  {
      ...
      createQuote() {
        (async () => {
          ...
          const valid = await this.$refs.transportInfo.validate();
          ...
          if (valid) {
            ...
            this.$swal.fire({
              title: `Creating ${this.entityTypeCapitalize}`,
              text: `Your ${this.entityTypeCapitalize} is being created`,
              onOpen: () => {
