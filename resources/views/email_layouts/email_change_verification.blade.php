...
<head>
    ...
    <title>Email Change Verification Notification for {{ config('app.name') }}</title>
...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: {{ $color }};">
<center style="width: 100%; background-color: {{ $color }};">
                ...
                <table style="width:100%;max-width:620px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="text-align: center; padding-bottom:25px">
                            ...
                            <p style="font-size: 14px; color: #2660f7; font-family: 'DM Sans', Arial, 'Helvetica Neue', sans-serif; padding-top: 12px;">
                                Email Change Verification Notification from {{ config('app.name') }}
                            </p>
                        </td>
                    </tr>
                    </tbody>
